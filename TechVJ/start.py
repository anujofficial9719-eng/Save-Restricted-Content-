...
async def send_start(client: Client, message: Message):
    ...
    buttons = [[
        InlineKeyboardButton("💞 Dᴇᴠᴇʟᴏᴘᴇʀ", url = "https://t.me/Godz_bots")
    ],[
        InlineKeyboardButton('Aᴅᴍɪɴ 🕊️', url='https://t.me/Godz_bots'),
        InlineKeyboardButton('Mᴏʀᴇ Iɴғᴏ 💞', url='https://t.me/Godz_Bots')
    ]]
